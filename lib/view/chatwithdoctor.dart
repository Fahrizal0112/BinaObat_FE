...
class _ChatWithDoctorState extends State<ChatWithDoctor> {
  ...
  Future<void> _sendMessage() async {
    if (_messageController.text.isNotEmpty) {
      ...
      setState(() {
        _messages.add({
          'sender_id': 'user', // Ganti dengan ID pengguna yang sebenarnya
          'message': message,
          'sent_at': DateTime.now().toIso8601String(),
          'sender_role': 'Patient',
          'sender_name': 'Nama Pengguna', // Ganti dengan nama pengguna yang sebenarnya
        });
      });
      try {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isUser = message['sender_role'] == 'Patient';
                return Align(
